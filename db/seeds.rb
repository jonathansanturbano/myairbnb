...
b8 = Bicycle.new(model: "Van Rysel Ultra Shimano Ultegra", description: "Fleuron de la gamme vélo route, ce vélo route carbone équipé d'une transmission électrique Ultegra DI2, vous apportera précision et performance ! Ultra performant, ce vélo carbone au groupe Shimano Ultegra DI2, vous apportera l'équilibre parfait entre légèreté, rendement et dynamisme !", price_per_day: 8, address: "Pont Alma, Paris", user_id: u4.id)
